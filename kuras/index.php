...
<div id="content">
  ...
  <div id="right">
    <center><h3>Login or sign up to get more opportunities</h3></center>
  </div>
  <div id="right2">
<center><h2>Log in</h2></center>
<form action="loginprocess.php" method="POST" >
<input type = "text" placeholder="Enter your username" name="Usernamee"><br><br>
<input type = "password" paceholder="Enter your password" name="Passworde" required><br>
  <input type="submit" value="Log In">
</form> 
<center><h3>Do not have an account? <a href="?a=1">Create it!</a></h3></center>
